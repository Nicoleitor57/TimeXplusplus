...
PATH_A_TU_EXPLICADOR_ENTRENADO = 'models/my_s4d_explainer.pt' # El explicador que entrenaste

# --- RUTA AL ECG QUE QUIERES EXPLICAR ---
PATH_A_UN_ECG_DAT = '../../S4D-ECG/exams/00001_lr.dat' # <<-- ¡AQUÍ PONES EL .dat A EXPLICAR!
